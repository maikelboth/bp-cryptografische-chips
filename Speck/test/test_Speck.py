...
class TestBPSpeck(TestCase):
	...
	def test_register_values_set_correctly(self):
		...
		self.assertEqual(13086198756631555644, values[3])
		self.assertEqual(14602580204519412693, values[4])
		self.assertEqual(2000143021029299983, values[5])
		self.assertEqual(13867416285273009822, values[6])
		self.assertEqual(5771282879215514673, values[7])
		self.assertEqual(14168928477211072166, values[8])
		self.assertEqual(6350807575834690766, values[9])
		self.assertEqual(2578544979115758229, values[10])
		self.assertEqual(6977039667070824382, values[11])
		self.assertEqual(441122036121552369, values[12])
		self.assertEqual(13831654436958558579, values[13])
		self.assertEqual(17069271371720262406, values[14])
		self.assertEqual(12148416450501388288, values[15])
		self.assertEqual(15260204053528369830, values[16])
		self.assertEqual(126441440922855510, values[17])
		self.assertEqual(9991915174888376624, values[18])
		self.assertEqual(1373025304360913802, values[19])
		self.assertEqual(7303535335452223808, values[20])
		self.assertEqual(17050466197131240311, values[21])
		self.assertEqual(15133961284916196885, values[22])
		self.assertEqual(5666866483476972917, values[23])
		self.assertEqual(13802561923659999880, values[24])
		self.assertEqual(8747893489135413107, values[25])
		self.assertEqual(129179017315910753, values[26])
		self.assertEqual(15424141043077198385, values[27])
		self.assertEqual(9739864489950961510, values[28])
		self.assertEqual(9866432828159742340, values[29])
		self.assertEqual(13530973622405294063, values[30])
		self.assertEqual(8674213117595946264, values[31])
